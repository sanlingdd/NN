...
ctx = utils.try_gpu()
net.load_params('data/oldBank/oldBank-19', ctx)


predictCategory = 'NextDayHighPriceIncrease1'
...
predictNames = ['NextDayHighPriceIncrease1']
...
predict_acc, predict_1acc = utils.evaluate_accuracy(utils.data_iter(X_Predict,y_Predict,batch_size), net, ctx)
print("Predict acc: %f,Predict True Value acc: %f" % (predict_acc,predict_1acc))
